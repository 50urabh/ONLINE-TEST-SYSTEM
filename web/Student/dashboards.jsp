                    ...
                    <div class="col-lg-4 col-xlg-4 col-md-4">
                        <div class="card">
                            <div class="card-block">
                                    ...
                                    <center class="m-t-50"> <img src="../${stud.image}"  class="img-circle" width="250" />
                                    <h4 class="card-title m-t-10">${stud.name}</h4>
                            ...
                            <div class="card-block">
                                 <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${student.userid}" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <br>
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${student.name}" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="${student.email}" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${student.phone}" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <br>
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${student.address}" class="form-control form-control-line">
                                        </div>
                                    </div>
