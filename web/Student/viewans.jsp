...
<%@page import="com.beans.Answers"%>
<%@page import="com.daos.AnsDaos"%>
    ...
    <div id="main-wrapper">
       ...
       <div class="page-wrapper">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <font size="20" color="#0080ff" face="Courier New">  <h1> <b><u>SUBMITTED ANSWERS </u></b></h1></font>
          ...
          <div class="row table-responsive">
              <table class="table">
                  <tr>
                         <td><b>Question</b></td> <td><b>Submitted Answer</b></td> <td><b>Correct Option</b></td>
                      <%
                  ...
                  <tr>
                      ...
                      <td><%=answer.getQues()%></td>
                        <td><%=answer.getSubmitans()%></td>
                         <td><%=answer.getCorrectop()%></td>
