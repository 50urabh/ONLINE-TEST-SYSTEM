                    ...
                    <div class="col-lg-6 col-xlg-8 col-md-6">
                        <div class="card">
                            <div class="card-block">
                                    ...
                                    <center class="m-t-50"> <img src="../${teacher.image}"  class="img-circle" width="250" />
                            ...
                            <div class="card-block">
                              <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${teacher.userid}" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <br>
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${teacher.name}" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="${teacher.email}" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${teacher.phone}" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <br>
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="${teacher.address}" class="form-control form-control-line">
                                        </div>
                                    </div>
