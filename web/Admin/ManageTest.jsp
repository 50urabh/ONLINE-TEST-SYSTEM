    ...
    <div id="main-wrapper">
       ...
       <div class="page-wrapper">
          ...
          <div class="row table-responsive">
               <table class="table">
                     <tr>
                      <td><b>Title</b></td><td><b>Uploaded By</b></td><td><b>Current Action</b></td><td><b>Details</b></td><td><b>Action</b></td>
                      <%
                  ...
                  <tr>
                        ...
                        <td>   <a href="detailtests.jsp?testid=<%=tests.getTestid()%>" class="btn btn-primary">TEST DETAILS</a> </td>
                        <td><a href="updateStatus.jsp?op=update_status&id=<%=tests.getTestid()%>" class="btn btn-primary">Change Status</a></td>
                  </tr>
                        <%}
