...
<body class="fix-header fix-sidebar card-no-border">
       ...
       <div class="page-wrapper">
        ...
        <%
          ...
          <tr>
              ...
              <td> <a href="SubjectController?id=<%=subjects.getSubid()%>&op=delete"><i class="fa fa-trash fa-lg" aria-hidden="true"></i></a>
        </td>
          </tr>
        ...
        <%}%>
            ...
            <br/>
    <span style="float:left"><a href="ManageSubject.jsp?start=<%=start-end%>" class="btn btn-primary <% if(start==0) out.println("disabled");%>"> Previous </a></span>
    <center>
    <%
     int pages = total/end + (total%end==0?0:1);
       ...
       <%}
        %>
     <span style="float:right"><a href="ManageSubject.jsp?start=<%=start+end%>" class="btn btn-primary <% if(start+end >=total)out.println(" disabled");%> "> NEXT </a></span>
    ...
    <div align="center">
        ...
        <br>
        <br>
    <a href='AddSubjects.jsp' align="right" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i>Add More Record</a>
