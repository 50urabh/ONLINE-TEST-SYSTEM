...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <!-- Row -->
                         <div class="row">
                                ...
                                <div class="card col col-md-10" style=" text-align: justify;text-justify: inter-word;">
                                    <div class="card-body">
                                        <div> <h2 class="card-title"><%=teacher.getName() %></h2>
                                        </div> <BR><BR>
                                
                                        <form  method="get" role="form" class="contactForm">    
                                            <h4>Change Status </h4>
              <br>  <span><h4><input type="radio" name="status"  class="form-control" value="Pending"/> <%if(teacher.getStatus().equals("Pending"))out.println(" checked"); %> <label> <b>Pending</b> </h4> </span>
                <br>  <span><h4><input type="radio" name="status"  class="form-control"  value="Approved"/> <%if(teacher.getStatus().equals("Approved"))out.println(" checked"); %> <label> <b>Approve</b> </h4> </span>
                <br>  <span><h4><input type="radio" name="status"  class="form-control" value="Rejected"/> <%if(teacher.getStatus().equals("Rejected"))out.println(" checked"); %> <label> <b>Reject</b> </h4> </span>
 ...
 <%
    if(request.getParameter("submit")!=null){
       ...
       if(td.updateTchrStatus(id, status)){ 
